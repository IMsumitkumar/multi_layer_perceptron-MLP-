...
class NeuralNetwork(object):
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        self.weights_input_to_hidden += learning_rate * del_w_input_hidden / n_records
        self.weights_hidden_to_output += learning_rate * del_w_hidden_output / n_records # update hidden-to-output weights with gradient descent step
